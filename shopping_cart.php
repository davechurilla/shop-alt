...
?>
      ...
      <tr bgcolor="#cce3ed">
        <td align="right" class="productListing-total"><b><?php echo SUB_TITLE_SUB_TOTAL; ?> <?php echo $currencies->format($cart->show_total()); ?></b></td>
      </tr>
<?php
...
<?php
  ...
  // if ($ot_cat_qvb_discount->output[0]["title"] != '') {
?>
<!--       <tr>                 
       <td align="left" style="padding: 5px 0;"><strong>Your order qualifies for the following discount, which will be reflected in the final total at checkout:</strong></td>
      </tr>
      <tr>
        <td align="left">
          ...
          <table width="100%" class="borderGray" cellpadding="4">
                <tbody>
                <tr>
                 <td align="center" class="discountHead" nowrap="">Patient Brochures Offer</td>
                 <td align="center" class="discountMain" bgcolor="#ffffe0"><strong><?php //echo $ot_cat_qvb_discount->output[0]["title"] ?> <?php //echo $ot_cat_qvb_discount->output[0]["text"] ?></strong><br></td>
                </tr>
               </tbody>
          </table>
        </td>
          ...
          <tr>
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="main" width="75"><?php echo tep_image_submit('button_update_cart.gif', IMAGE_BUTTON_UPDATE_CART); ?></td>
<?php
    $back = sizeof($navigation->path)-2;
    if (isset($navigation->path[$back])) {
?>
                <td class="main" width="150"><?php echo '<a href="' . tep_href_link($navigation->path[$back]['page'], tep_array_to_string($navigation->path[$back]['get'], array('action')), $navigation->path[$back]['mode']) . '">' . tep_image_button('button_continue_shopping.gif', IMAGE_BUTTON_CONTINUE_SHOPPING) . '</a>'; ?></td>
<?php
    }
?>
