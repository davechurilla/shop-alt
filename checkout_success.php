      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="4" cellpadding="2">
          <tr>
            ...
            <td valign="top" class="main"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?><div class="pageHeading"><?php echo HEADING_TITLE; ?></div><br>
            
            
            <?php echo TEXT_SUCCESS; ?>
            <h3><?php echo TEXT_CHECK_SPAM; ?></h3><br>
<?php
  //PWA BOF
