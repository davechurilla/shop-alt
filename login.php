    ...
    <td width="100%" valign="top"><?php echo tep_draw_form('login', tep_href_link(FILENAME_LOGIN, 'action=process', 'SSL')); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo tep_image_button('title_login.gif'); ?></td>
...
for ($i = 0; $i < $length; $i++) {
  if($products[$i]['model']) {$onlineCourse = true;}
}
...
<table border="0" width="100%" height="100%" cellspacing="1" cellpadding="2" class="infoBox_login">
              <tr>
                <td><table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    <td class="blue_title" colspan="2"><?php echo TEXT_RETURNING_CUSTOMER; ?></td>
                  </tr>
                  <tr>
                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                  </tr>
                  ...
                  <tr>
                    <td class="main"><?php echo tep_image_submit('button_login.gif', IMAGE_BUTTON_LOGIN); ?></td><td><span class="smallText"><?php echo ' &nbsp; <a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></span></td>
                  </tr>
                  <tr>
                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                  </tr>
            ...
            <table border="0" width="100%" height="100%" cellspacing="1" cellpadding="2" class="infoBox_login">
              <tr>
                <td><table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    <td class="blue_title" valign="top"><?php echo TEXT_NEW_CUSTOMER; ?></td>
                  </tr>
                  <tr>
                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                  </tr>                  
                  ...
                  <tr>
                        ...
                        <td class="main"><?php echo '<a href="' . tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL') . '">' . tep_image_button('button_createacct.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></td>
