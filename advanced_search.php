...
<?php
  ...
  $info_box_contents[] = array('text' => '<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="account-heading"><b class="main">' . HEADING_SEARCH_CRITERIA . '</b></td></tr></table>');
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="smallText" align="left"><?php echo tep_image_submit('button_search.gif', IMAGE_BUTTON_SEARCH); ?></td>
            <td></td>
          </tr>
        </table></td>
      </tr>
