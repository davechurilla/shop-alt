...
// PWA EOF
    ...
    function cart() {
      ...
      $customer_address_query = tep_db_query("select c.customers_firstname, c.customers_lastname, c.customers_title, c.customers_telephone, c.customers_email_address, c.guest_account, ab.entry_company, ab.entry_street_address, ab.entry_suburb, ab.entry_postcode, ab.entry_city, ab.entry_zone_id, z.zone_name, co.countries_id, co.countries_name, co.countries_iso_code_2, co.countries_iso_code_3, co.address_format_id, ab.entry_state from " . TABLE_CUSTOMERS . " c, " . TABLE_ADDRESS_BOOK . " ab left join " . TABLE_ZONES . " z on (ab.entry_zone_id = z.zone_id) left join " . TABLE_COUNTRIES . " co on (ab.entry_country_id = co.countries_id) where c.customers_id = '" . (int)$customer_id . "' and ab.customers_id = '" . (int)$customer_id . "' and c.customers_default_address_id = ab.address_book_id");
      ...
      if (is_array($sendto) && !empty($sendto)) {
        $shipping_address = array('entry_firstname' => $sendto['firstname'],
                                  ...
                                  'entry_title' => $sendto['customers_title'],
      ...
      $this->customer = array('firstname' => $customer_address['customers_firstname'],
                              ...
                              'customers_title' => $customer_address['customers_title'],
