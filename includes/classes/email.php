...
// $pMail->IsSMTP(); 
// $pMail->Host     = "mail.advancedlasertraining.com"; // replace with your smtp server
// $pMail->Username = "mowens@advancedlasertraining.com"; // replace with your smtp username (if SMTPAuth is true)
// $pMail->Password = "quarrylane";    // replace with your smtp password (if SMTPAuth is true)
