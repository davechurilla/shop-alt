...
//to define title image for cats
$cat_title_img = '<img src="images/title_cat_' . substr($cPath, 0, 1) . '.gif" border="0" />';	
...
$cat_title_img = '<img src="images/title_cat_' . substr($cPath, 0, 1) . '.gif" border="0" />';	
    ...
    $template_pinfo['cat_title'] = $cat_title_img;	
...
//$template_pinfo['product_quantity'] = TEXT_PRODUCT_QUANTITY . tep_draw_pull_down_menu('quantity',$products_quantity_array,1);
...
$template_pinfo['product_quantity'] = '<td><strong>' . TEXT_PRODUCT_QUANTITY . '</strong></td><td>'. tep_draw_pull_down_menu('quantity',$products_quantity_array,1) . '</td>';

//} else {

//$template_pinfo['product_quantity'] = '';
...
if ($products_attributes['total'] > 0) {
  ...
  while ($products_options_name = tep_db_fetch_array($products_options_name_query)) {
    ...
    $template_pinfo['optionnames'] .= '<div style="padding-bottom:5px;">' . $products_options_name['products_options_name'] . ':</div>'; 
    $template_pinfo['optionchoices'] .= '<div style="padding-bottom:5px;">' . tep_draw_pull_down_menu('id[' . $products_options_name['products_options_id'] . ']', $products_options_array, $selected_attribute) . "</div>"; 
  }
} else {
