...
define('ENTRY_TITLE_ERROR', 'Your title selection must have a value.');
define('ENTRY_TITLE_ERROR_SELECT', 'Please select a title from the Title pull down menu.');
...
define('TEXT_GREETING_GUEST', 'Welcome. Please <a href="%s"><u>sign in</u></a> or <a href="%s"><u>create an account</u></a>.');
