...
define('TABLE_HEADING_COMMENTS', 'Add Comments About Your Order.<br /><font color="red">For manufacturer\'s credit, you MUST include in the comment field the laser manufacturer\'s name, model of the laser you have purchased, and the following information depending on the manufacturer:<ul> <li>Burkhart &mdash; Access Code - Must choose Credit Card as payment and provide $100 payment to receive the course</li> <li>DenMat &mdash; Customer Number</li> </ul></font>');
