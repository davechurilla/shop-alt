...
//	    $this->show_correct_answers == true ? 	
        ...
        public function BuildAnswers($ans_results,$question_type)
        {
             ...
             {                 
                  ...
                  break;
                  case 1:
                      if($this->show_correct_answers==true && $row['correct_answer']=="1") { $correct_answer = "<font color=green>$tabs (".CORRECT_ANSWER.")</font>"; }
                      elseif($this->show_correct_answers==true && $row['correct_answer']!="1") { $correct_answer = "<font color=red>$tabs (Incorrect&nbsp;answer)</font>"; }
                      if($this->user_quiz_id>-1 && $row['user_answer_id']!="") $answers_val = "checked";
                      //Added line below to show $correct_answer only if radio button is selected
                      if($answers_val != "checked") $correct_answer = "";
