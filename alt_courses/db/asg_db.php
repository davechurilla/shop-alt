...
class asgDB
{
    ...
    public static function ChangeLimited($limited,$id)
    {
        $sql = "update assignments set limited=$limited where id=$id";
        return db::exec_sql($sql);
    }    
    ...
    {
        $sql ="select uq.*,q.quiz_name,q.intro_text,asg.quiz_type,asg.results_mode,asg.show_results ,asg.allow_review,".
