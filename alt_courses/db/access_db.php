...
class access_db {
    ...
    {
        $query= "select m.*, u.UserID as user_id, u.user_type,u.password,u.Name,u.Surname,u.customers_title,u.email, 0 as imported from users u " .
        ...
        $query.=" union ";
        $query.="select m.*, u.UserID as user_id, 2 as user_type,u.password,u.Name,u.Surname,u.customers_title,u.email, 1 as imported from v_imported_users u ".
