...
<link rel="stylesheet" type="text/css" href="style/index_green.css" media="screen" />
...
echo "<li><a href='?module=show_page&id=".$row['id']."'>".$row['page_name']."</a></li>";
} } ?>
</ul>
</div>
...
{
?>
<h2><?php echo $MODULES[$main_modules[$z]['module_name']] ?></h2>
<ul>
<?php for($y=0;$y<sizeof($child_modules[$main_modules[$z]['id']]);$y++) {
$file_name = $child_modules[$main_modules[$z]['id']][$y]["file_name"];
echo "<li><a href='index.php?module=$file_name'>".$MODULES[$child_modules[$main_modules[$z]['id']][$y]["module_name"]]."</a></li> ";
 } ?>
</ul>
<? } }?>
