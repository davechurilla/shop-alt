...
*/
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'process')) {
    ...
    if (tep_db_num_rows($check_customer_query)) {
      ...
      //replace newly reset password in exam software system
      tep_db_query("update v_imported_users set Password = '" . tep_db_input($crypted_password) . "' where UserID = '" . (int)$check_customer['customers_id'] . "'");
